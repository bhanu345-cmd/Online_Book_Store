        ...
        return(
            ...
            <nav className="navbar">
                    <ul className="navbar-nav w-100 ">
                        ...
                        <li className="nav-item text-center">
                        <Link className="nav-link text-dark" to="/#">Category 3</Link>
                        </li>
                    </ul>
            </nav>
            </div>
            ...
            <nav className="navbar">
                    <ul className="navbar-nav w-100">
                        <li className="nav-item text-center">
                        <Link className="nav-link text-dark" to="/#">Autho 1</Link>
                        </li>
                        <li className="nav-item text-center">
                        <Link className="nav-link text-dark" to="/#">Author 2</Link>
                        </li>
                        <li className="nav-item text-center">
                        <Link className="nav-link text-dark" to="/#">Author 3</Link>
                        </li>
                    </ul>
            </nav>
            </div>
